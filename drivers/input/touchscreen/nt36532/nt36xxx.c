...
int switch_pen_input_device(void)
{
	...
	NVT_LOG("pen_bluetooth_connect is %d, pen_charge_connect is %d, game_mode_enable %d, %s pen input device\n",
		ts->pen_bluetooth_connect, ts->pen_charge_connect,
